...
export class ImageUploadComponent implements OnInit {
  ...
  doUploadFile(){
    if(this.typeOfUpload === 'profilePicture'){
      this.actionUrl = "https://angularkandoe.herokuapp.com/api/private/users/" + sessionStorage.getItem(USERNAME) + "/uploadImage";
    }
    else if(this.typeOfUpload === 'gameSessionImage'){
      this.actionUrl = "https://angularkandoe.herokuapp.com/api/private/users/" + sessionStorage.getItem(USERNAME) + "/sessions/" + this.createdSessionId + "/uploadImage";
    }
